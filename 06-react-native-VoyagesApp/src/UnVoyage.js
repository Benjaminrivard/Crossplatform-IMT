...
export default class UnVoyage extends React.Component {
  ...
  ajouterLieu = () => {
    ...
    this.props.navigation.getScreenProps()["ajoutLieu"](voyage, lieu);
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <ScrollView
          contentContainerStyle={[!voyage.lieux.length && { flex: 1 }]}
        >
          <View
            style={[
